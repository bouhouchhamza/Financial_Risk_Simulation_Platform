...
@section('content')
<section class="unified-user-page fraud-rules-page fraud-rule-edit-page">
    <div class="page-header">
        <div class="page-title-wrap">
            <h1 class="page-title">Edit Fraud Rule</h1>
            <p class="page-subtitle">Update thresholds and activation state for this detection rule.</p>
        </div>
