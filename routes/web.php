...
Route::middleware('auth')->group(function () {
    ...
    // Startup
    Route::get('/startups', [StartupController::class, 'show'])->name('startups.index');
    ...
    // Transactions (MVP CRUD scope requested)
    ...
    Route::get('/fraud/{startup}', [FraudDetectionController::class, 'show'])->name('fraud.show');
